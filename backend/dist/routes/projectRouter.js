...
router.get('/:pid', idMiddleware_js_1.validatePid, projectController_js_1.getProject); // pid에 해당하는 프로젝트 정보
...
router.delete('/delete/:pid', idMiddleware_js_1.validatePid, checkUserRole_js_1.checkUserRole, projectController_js_1.deleteProject); // 프로젝트 삭제
