...
const newIssue = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const validStatuses = {
            Backlog: issueTypes_1.Status.Backlog,
            Working: issueTypes_1.Status.Working,
            Dev: issueTypes_1.Status.Dev,
            QA: issueTypes_1.Status.QA,
        };
        const status = (0, helpers_1.validateAndMap)(req.body.status, validStatuses, 'Status');
        // Type 값 검증 및 변환
        const validTypes = {
            process: issueTypes_1.Type.process,
            bug: issueTypes_1.Type.bug,
        };
        ...
        const issue = {
            ...
            type: type || issueTypes_1.Type.process,
            status: status || issueTypes_1.Status.Backlog, // 변환된 status 사용
            sprint_id: sprintId,
            project_id: pid,
